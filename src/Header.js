                ...
                <nav className="navbar navbar-light bg-light">
                    <div className="container-fluid">
                        ...
                        <ul className="nav justify-content-end">
                            ...
                            <li className={`nav-item`} >
                                <a className={`nav-link ${this.props.linkStatus[1]}`} href="/bikinkuis">Create Quiz</a>
                            </li>
                            <li className={`nav-item`} >
                                <Link className={`nav-link ${this.props.linkStatus[2]}`} to="#">Attempt Quiz</Link>
                            </li>
                            <li className={`nav-item`} >
                                <Link className={`nav-link ${this.props.linkStatus[3]}`} to="#" >About Quiz</Link>
                            </li>
                        </ul>
                    </div>
                </nav>
